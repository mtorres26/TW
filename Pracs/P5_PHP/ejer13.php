...
<body>
    ...
    <!-- Para resolver el problema de inyección, usamos la funcion strip_tags que elimina los tags (<h1> por ejemplo)de la cadena que le pasemos -->
    <p class="bienvenido">Bienvenido/a <?php if(isset($_GET['nombre'])) echo strip_tags($_GET['nombre']); ?>, siga instrucciones a continuación:</p>    
        <fieldset>
